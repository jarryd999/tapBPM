...
/***/ function(module, exports, __webpack_require__) {
	...
	var TapBPM = function (_React$Component) {
		_inherits(TapBPM, _React$Component);

		function TapBPM(props) {
			_classCallCheck(this, TapBPM);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TapBPM).call(this, props));

			_this.state = {
				previousTimestamp: null, bpm: null
			};
			_this.calculateBPM = _this.calculateBPM.bind(_this);
			return _this;
		}

		_createClass(TapBPM, [{
			key: 'calculateBPM',
			value: function calculateBPM() {
				if (this.state.previousTimestamp == null) {
					this.state.previousTimestamp = new Date().getTime();
					return;
				}
				var timestamp = new Date().getTime();
				var timeDiff = timestamp - this.state.previousTimestamp;

				var bpm = 60000 / timeDiff;
	...
	exports.default = TapBPM;

	_reactDom2.default.render(_react2.default.createElement(TapBPM, null), document.getElementById('tapBPMouter'));
